	...
	JFrame frame;
       ...
       EmployeeLogin(){
    	    ...
    	    int height=(int) tk.getScreenSize().getHeight();
    	      ...
    	      ImageIcon adImg = new ImageIcon("C:\\Users\\AHsan Usmani\\Desktop\\Programs\\Project GMS\\src\\man1.png");   //Background image path
    	      ...
    	      frame.add(adminImage);
    	        ...
    	        JLabel adlabel =new JLabel("EMPLOYEE LOGIN");     //Administrator login text object: adlabel
    	        Font font=new Font("LucidaGrande",Font.PLAIN + Font.BOLD,24);     //Administrator Login text font
    	        adlabel.setFont(font);         
    	        adlabel.setBounds(860,395,350,35);						//Administrator Login text x, y, width , height
    	        frame.add(adlabel);
...
//    	      	   								});
        	     ...
        	     frame.add(password);
    	           													...
    	           													public void actionPerformed(ActionEvent e) {
    	           														...
    	           														if(e.getSource()==LoginB) {
    	           															if((username.getText().equals("") || username.getText().equals("Username") )&& (password.getText().equals("") || password.getText().equals("Password")))
    	           															{
    	           																...
    	           																JOptionPane.showMessageDialog(null,"Please enter username / password","Warrning",JOptionPane.WARNING_MESSAGE,ig1);
    	           																...
    	           																ImageIcon ig1=new ImageIcon("C:\\Users\\AHsan Usmani\\Desktop\\Programs\\Project GMS\\src\\error.png");
    	           																JOptionPane.showMessageDialog(null,"Please enter a username","Warrning",JOptionPane.WARNING_MESSAGE,ig1);
    	           																}
    	           																								
    	           															else if(password.getText().equals("") || password.getText().equals("Password")) {
    	           																ImageIcon ig1=new ImageIcon("C:\\Users\\AHsan Usmani\\Desktop\\Programs\\Project GMS\\src\\error.png");
    	           																JOptionPane.showMessageDialog(null,"Please enter a password","Warrning",JOptionPane.WARNING_MESSAGE,ig1);  }
    	           																  ...
    	           																  try {
    	           																	  ...
    	           																	  if(rst.next())  {
    	           																		  ...
    	           																		  if(username.getText().equals(rst.getString(2)) && password.getText().equals(rst.getString(3))){
																							...
																							Employee obj=new Employee();
        	           																		...
        	           																		ImageIcon ig1=new ImageIcon("C:\\Users\\AHsan Usmani\\Desktop\\Programs\\Project GMS\\src\\error.png");
        	    	           																JOptionPane.showMessageDialog(null,"Wrong Username or password","Warrning",JOptionPane.WARNING_MESSAGE,ig1);
        	           																	  }
    	           																	  }
    	           												...
    	           												Forget.addActionListener(new ActionListener() {
																	...
																	public void actionPerformed(ActionEvent e) {
																		if(e.getSource()==Forget) {
																			...
																			ImageIcon ig1=new ImageIcon("C:\\Users\\AHsan Usmani\\Desktop\\Programs\\Project GMS\\src\\error.png");
	           																JOptionPane.showMessageDialog(null,"Please Contact your administrator","Warrning",JOptionPane.WARNING_MESSAGE,ig1);  
	           																}
																	}
    	           												});
    	           ...
    	           ChangePas.setBorder(BorderFactory.createDashedBorder(new Color(245,245,250)));    //Password changed Button border
    	           ...
    	           SecQue.setBorder(BorderFactory.createDashedBorder(new Color(245,245,250)));  //Change Security Question Button Border panel color
    	           ...
    	           //Implements Panel in the JFrame work
    	    	      ...
    	    	      panel.setBounds ( width/2 -P_width/2 , height/2 - P_height/2, P_width ,P_height);   				 // width/2 -P_width/2     height/2 - P_height/2
    	    	      panel.setBackground(new Color(245,245,250));	//suppose the Width & height of any Screen is 1920 & 1080.            1920/2 - 420/2		1080/2  - 550/2	    
    	    	      frame.add(panel);
    	    	    ...
    	    	    //Background1
    	      	    ImageIcon background_image=new ImageIcon("C:\\Users\\AHsan Usmani\\Desktop\\Programs\\Project GMS\\src\\background.jpg");
